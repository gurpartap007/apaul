...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_widget1_t, stringdata) + ofs \
...
const QMetaObject widget1::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_widget1.data,
      qt_meta_data_widget1,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_widget1.stringdata))
        return static_cast<void*>(const_cast< widget1*>(this));
