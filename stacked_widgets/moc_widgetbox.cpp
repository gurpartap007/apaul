...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_widgetbox_t, stringdata) + ofs \
...
QT_MOC_LITERAL(2, 29, 0)
    ...
    "widgetbox\0on_widget1_clicked\0\0"
};
...
void widgetbox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->on_widget1_clicked(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject widgetbox::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_widgetbox.data,
      qt_meta_data_widgetbox,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_widgetbox.stringdata))
